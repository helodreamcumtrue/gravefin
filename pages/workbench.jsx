...
export default function ArchivistWorkbenchPage() {
  ...
  const mySpecimens = projects.slice(0, 4);
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
              <div className="sketch-card" style={{ padding: 16, backgroundColor: 'var(--color-paper)' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', fontFamily: 'var(--font-mono)', fontSize: 11, color: 'rgba(17, 17, 17, 0.65)', marginBottom: 4 }}>
                  <span style={{ fontWeight: 700, color: 'var(--color-ink)' }}>AI Adaptive Study Plan Generator</span>
                ...
                <Link href="/project/p1" style={{ fontSize: 12, fontFamily: 'var(--font-mono)', color: 'var(--color-ink)', textDecoration: 'underline', display: 'inline-block', marginTop: 6 }}>
              ...
              <div className="sketch-card" style={{ padding: 16, backgroundColor: 'var(--color-paper)' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', fontFamily: 'var(--font-mono)', fontSize: 11, color: 'rgba(17, 17, 17, 0.65)', marginBottom: 4 }}>
                  <span style={{ fontWeight: 700, color: 'var(--color-ink)' }}>Campus Shuttle Live Radar & Dispatch</span>
                  <span>3 days ago</span>
                </div>
                <p style={{ margin: 0, fontSize: 13.5, color: 'rgba(17, 17, 17, 0.85)', lineHeight: 1.45 }}>
                  "Suggested decoupling transport provider layer to allow self-hosted Mapbox or open-source Leaflet GeoJSON feeds."
                </p>
                <Link href="/project/p2" style={{ fontSize: 12, fontFamily: 'var(--font-mono)', color: 'var(--color-ink)', textDecoration: 'underline', display: 'inline-block', marginTop: 6 }}>
                  View Specimen Record →
                </Link>
              </div>
              ...
              <div className="sketch-card" style={{ padding: 16, backgroundColor: 'var(--color-paper)' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', fontFamily: 'var(--font-mono)', fontSize: 11, color: 'rgba(17, 17, 17, 0.65)', marginBottom: 4 }}>
                  <span style={{ fontWeight: 700, color: 'var(--color-ink)' }}>WebAssembly Modular Audio Synth</span>
                  <span>1 week ago</span>
                </div>
                <p style={{ margin: 0, fontSize: 13.5, color: 'rgba(17, 17, 17, 0.85)', lineHeight: 1.45 }}>
                  "C++ DSP core compiles cleanly with Emscripten. Web Audio AudioWorklet node buffer alignment confirmed."
                </p>
                <Link href="/project/p7" style={{ fontSize: 12, fontFamily: 'var(--font-mono)', color: 'var(--color-ink)', textDecoration: 'underline', display: 'inline-block', marginTop: 6 }}>
                  View Specimen Record →
                </Link>
              </div>
            </div>
          ...
          <div className="sketch-card-static" style={{ padding: 24, display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
              ...
              >
                <div>
                  ...
                  <p style={{ fontSize: 12, fontFamily: 'var(--font-mono)', color: 'rgba(17, 17, 17, 0.7)', margin: 0 }}>
                    Plan: Deliver PDF invoice generator & automated dispatch worker with 100 cr escrow locked
                  </p>
                </div>
              ...
              >
                <div>
                  <span className="sketch-tag" style={{ padding: '2px 8px', fontSize: 11, fontFamily: 'var(--font-mono)', fontWeight: 700 }}>
                    PROJECT: EDGE SENSOR IOT
                  </span>
                  <h4 style={{ fontFamily: 'var(--font-sans)', fontWeight: 700, fontSize: 16, margin: '6px 0 2px', color: 'var(--color-ink)' }}>
                    Work Submitted for Owner Verification
                  </h4>
                  <p style={{ fontSize: 12, fontFamily: 'var(--font-mono)', color: 'rgba(17, 17, 17, 0.7)', margin: 0 }}>
                    Status: Digger-3310 submitted completed Chart.js calibration widgets. Awaiting owner sign-off.
                  </p>
                </div>
